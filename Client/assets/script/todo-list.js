    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            data.forEach(element => {
                ...
                let $checkbox = $tableTodoContent.append(`<td><input type="checkbox" class="form-check-input" id="done-checker${element.id}" ${element.status ? "checked": ""}>`)
